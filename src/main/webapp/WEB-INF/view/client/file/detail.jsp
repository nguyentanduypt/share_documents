                        ...
                        <div class="container py-5">
                            ...
                            <c:if test="${not empty doc}">
                                <div class="rounded border border-secondary p-4 shadow-sm bg-white">
                                    ...
                                    <p><strong>Ngày đăng:</strong> ${uploadDateFormatted}</p>
                                    ...
                                    <c:choose>
                                        <c:when test="${fn:endsWith(doc.fileName, '.pdf')}">
                                            <iframe src="/file/${doc.id}" width="100%" height="600px"
                                                allowfullscreen></iframe>
                                        </c:when>

                                        <c:when test="${fn:endsWith(doc.fileName, '.docx')}">
                                        ...
                                        <c:when
                                            test="${fn:endsWith(doc.fileName, '.txt') || fn:endsWith(doc.fileName, '.csv')}">
                                            <iframe src="/file/${doc.id}" width="100%" height="600px"></iframe>
                                        </c:when>

                                        <c:when
                                            test="${fn:endsWith(doc.fileName, '.jpg') || fn:endsWith(doc.fileName, '.jpeg') || fn:endsWith(doc.fileName, '.png')}">
                                            <img src="/file/${doc.id}"
